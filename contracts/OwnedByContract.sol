...
contract OwnedByContract is Ownable{
    ...
    */
    ...
    /**
    * @dev Allows the current owner to transfer control of the contract to a new smart contract.
    * @param newOwner The address to transfer ownership to. Throws an error if the address is an EOA.
    */
